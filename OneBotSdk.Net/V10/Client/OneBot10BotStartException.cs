...
/// </summary>
public sealed class OneBot10BotStartException : Exception
{
    /// <summary>
    ...
    public OneBot10BotStartException(OneBot10Response<OneBot10LoginInfoData> loginInfoResponse)
    ...
    /// </summary>
    public OneBot10Response<OneBot10LoginInfoData> LoginInfoResponse { get; }

    private static string CreateMessage(OneBot10Response<OneBot10LoginInfoData>? response)
    {
        if (response == null)
        {
