...
/// </summary>
internal static class OneBot10TransportPayload
{
    ...
    internal static JsonObject ParseObject(string payload)
    {
        ...
        try
        {
            var root = OneBot10Json.Parse(payload) as JsonObject;
            if (root == null)
            {
                throw new OneBot10TransportException(
                    OneBot10TransportError.ProtocolViolation,
    ...
    internal static JsonNode? Clone(JsonNode? source)
    {
        ...
        return OneBot10Json.Clone(source);
    }

    internal static OneBot10TransportException TooLarge(int maximumBytes)
    {
        return new OneBot10TransportException(
            OneBot10TransportError.MessageTooLarge,
