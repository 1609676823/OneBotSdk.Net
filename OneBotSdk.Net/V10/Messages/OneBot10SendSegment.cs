...
/// <summary>
/// Defines a segment that is valid as an outgoing OneBot 10 API parameter.
/// 定义可作为 OneBot 10 出站 API 参数的消息段。
/// </summary>
[JsonConverter(typeof(OneBot10SendSegmentJsonConverter))]
public abstract class OneBot10SendSegment
{
    /// <summary>Initializes an outgoing segment discriminator. / 初始化出站消息段判别值。</summary>
    protected OneBot10SendSegment(string type)
    {
