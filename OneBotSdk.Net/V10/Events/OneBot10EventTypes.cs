...
/// <summary>
/// Provides the discriminator strings used by standard OneBot 10 events.
/// 提供标准 OneBot 10 事件使用的判别字符串。
/// </summary>
public static class OneBot10EventTypes
{
    ...
    /// <summary>The discussion-group message type. / 讨论组消息类型。</summary>
    public const string DiscussMessage = "discuss";
