...
/// <summary>
/// Computes and verifies the OneBot 11 reverse HTTP <c>X-Signature</c> value.
/// 计算并验证 OneBot 11 反向 HTTP 的 <c>X-Signature</c> 值。
/// </summary>
public static class OneBot11HttpPostSignature
{
