...
public sealed partial class OneBot11Client
{
    ...
    /// </remarks>
    public Task<OneBot11Response> SetGroupKickAsync(
        long groupId,
        long userId,
    ...
    public Task<OneBot11Response> SetGroupBanAsync(
        long groupId,
        long userId,
        long duration = 1800,
        InvocationMode invocationMode = InvocationMode.Normal,
    ...
    public Task<OneBot11Response> SetGroupAnonymousBanAsync(
        long groupId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return SendWithoutDataAsync(
            OneBot11Actions.SetGroupAnonymousBan,
            new JsonObject
            {
                ["group_id"] = groupId,
    ...
    public Task<OneBot11Response> SetGroupWholeBanAsync(
        long groupId,
        bool enable = true,
        InvocationMode invocationMode = InvocationMode.Normal,
        JsonNode? echo = null,
    ...
    {
        return SendWithoutDataAsync(
            OneBot11Actions.SetGroupWholeBan,
            new JsonObject
            {
                ["group_id"] = groupId,
                ["enable"] = enable
    ...
    public Task<OneBot11Response> SetGroupAdminAsync(
        long groupId,
        long userId,
        bool enable = true,
        InvocationMode invocationMode = InvocationMode.Normal,
    ...
    public Task<OneBot11Response> SetGroupAnonymousAsync(
        long groupId,
        bool enable = true,
        InvocationMode invocationMode = InvocationMode.Normal,
        JsonNode? echo = null,
    ...
    {
        return SendWithoutDataAsync(
            OneBot11Actions.SetGroupAnonymous,
            new JsonObject
            {
                ["group_id"] = groupId,
                ["enable"] = enable
    ...
    public Task<OneBot11Response> SetGroupCardAsync(
        long groupId,
        long userId,
        string card = "",
        InvocationMode invocationMode = InvocationMode.Normal,
    ...
    /// <summary>Sets a group's name. / 设置群名称。</summary>
    public Task<OneBot11Response> SetGroupNameAsync(
        long groupId,
        string groupName,
        InvocationMode invocationMode = InvocationMode.Normal,
        JsonNode? echo = null,
    ...
    /// </remarks>
    public Task<OneBot11Response> SetGroupLeaveAsync(
        long groupId,
    ...
    public Task<OneBot11Response> SetGroupSpecialTitleAsync(
        long groupId,
        long userId,
        string specialTitle = "",
        long duration = -1,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return SendWithoutDataAsync(
            OneBot11Actions.SetGroupSpecialTitle,
            new JsonObject
            {
                ["group_id"] = groupId,
                ["user_id"] = userId,
