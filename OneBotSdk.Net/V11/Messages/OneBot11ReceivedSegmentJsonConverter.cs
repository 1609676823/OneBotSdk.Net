...
/// </summary>
public sealed class OneBot11ReceivedSegmentJsonConverter : JsonConverterFactory
{
    /// <inheritdoc />
    public override bool CanConvert(Type typeToConvert)
    {
        return typeof(OneBot11ReceivedSegment).IsAssignableFrom(typeToConvert);
    }
        ...
        where TSegment : OneBot11ReceivedSegment
    {
        ...
        public override TSegment? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var parsed = OneBot11ReceivedSegment.Parse(JsonNode.Parse(ref reader));
