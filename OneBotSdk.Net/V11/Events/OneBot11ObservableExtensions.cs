...
/// </summary>
public static class OneBot11ObservableExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static IObservable<TEvent> OfType<TEvent>(this IObservable<OneBot11Event> source)
    ...
    private sealed class TypeFilterObservable<TEvent> : IObservable<TEvent>
        where TEvent : OneBot11Event
    {
        private readonly IObservable<OneBot11Event> _source;

        internal TypeFilterObservable(IObservable<OneBot11Event> source)
        {
            _source = source;
        }
        ...
        private sealed class TypeFilterObserver : IObserver<OneBot11Event>
        {
            ...
            public void OnNext(OneBot11Event value)
            {
